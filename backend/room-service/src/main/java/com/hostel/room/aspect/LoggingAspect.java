package com.hostel.room.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.hostel.room.service.*.*(..))")
    ...
    public void logAfter(JoinPoint jp, Object result) {
        log.info("<< {}.{} returned: {}", jp.getSignature().getDeclaringTypeName(),
    ...
    @Around("execution(* com.hostel.room.controller.*.*(..))")
